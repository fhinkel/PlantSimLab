...
messages[7] = new Array('The file must be a plain text file and adhere to the format specified in the tutorial. Deterministic or stochastic functions for some variables can be given, the partial function information will overwrite any results found by using the input data.',"#DDECFF");
/*if (document.images) {
